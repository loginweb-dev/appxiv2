            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">APPXI</h1>
	                        <p class="hero-paragraph">Forma parte de nuestro Marketplace y aumenta exponencialmente tus ventas.</p>
	                        <div class="hero-cta"><a class="button button-shadow" href="#">Leer más</a><a class="button button-primary button-shadow" href="#">Registrar mi Negocio</a></div>
						</div>
						<div class="hero-app">
							...
							<img class="device-mockup" src="about/images/iphone-mockup.png" alt="App preview">
            ...
            <section class="features section">
                <div class="container">
					<div class="features-inner section-inner has-bottom-divider">
						<h2 class="section-title mt-0">Beneficios de formar parte de APPXI</h2>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Beneficio 1</h3>
							...
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Beneficio 2</h3>
                                    <p class="text-sm mb-0">A pseudo-Latin text used in web design, layout, and printing in place of things to emphasise design.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <ul class="footer-social-links list-reset">
                        <li>
                            <a href="https://www.facebook.com/appxi2022/">
                    ...
                    <div class="footer-copyright">&copy; 2022 APPXI, todos los derechos reservados</div>
                </div>
            </div>
        </footer>
    </div>

    <script src="about/js/main.min.js"></script>
</body>
</html>
