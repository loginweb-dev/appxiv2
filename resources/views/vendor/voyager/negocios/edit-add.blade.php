            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <!-- CSRF TOKEN -->
                        {{ csrf_field() }}
                        @if(Auth::user()->id==1 || Auth::user()->role_id==5 || $negocio->id==$dataTypeContent->getKey())
...
@section('javascript')
    ...
    <script>
        ...
        $('document').ready(function () {
            ...
            recargar()
            console.log('{{$dataTypeContent->getKey()}}')
        });
        ...
        async function recargar(){
            ...
            if (user.data.role_id==3) {
                ...
                var url_destino="{{setting('admin.url')}}admin/negocios/"+negocio.data.id+"/edit"
