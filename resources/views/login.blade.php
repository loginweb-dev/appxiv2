		...
		<hr>
			...
			<div class="getpin" hidden>				
				<div class="form-group panel confimar">
						<input id="pin" class="form-control" placeholder="Ingresan tu pin" type="text">
